...
for FLIPS in 1 2 3 4 5; do
    for FAULT_MODEL in "ORC" "IS" "SC"; do
        ...
        python3 ./experiments/experiment_symbolic.py "./experiments/smc/pr_VerifyPIN_0.q" --model $MODEL_PATH --query-output $QUERY_OUTPUT --log-output $LOG_OUTPUT
        ...
        for PROGRAM in \
            ...
            python3 ./experiments/experiment_symbolic.py "./experiments/smc/pr_VerifyPIN_1_2_3_4_5_6_7.q" --model $MODEL_PATH --query-output $QUERY_OUTPUT --log-output $LOG_OUTPUT
        done
    done
done
